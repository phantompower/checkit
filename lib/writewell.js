 ...
 */
writewell.prototype.addDictionary = function (dicFilePath, affFilePath) {
  if (!this._dictionary) {
 ...
 * @param {String} value
 */
writewell.prototype.setWhitelist = function (value) {
 ...
 * @param {String} value
 */
writewell.prototype.setBlacklist = function (value) {
  if(typeof value !== 'string') {
 ...
 */
writewell.prototype.setWriteGoodSettings = function (settings) {
 ...
 * @returns {Promise}
 */
writewell.prototype.proofread = function (html) {
